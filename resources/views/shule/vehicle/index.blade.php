...
<div class="row">
    <div class="col-12">
        <div class="card mb-3">
            <div class="card-body">
                <h4 class="mt-0 header-title">Vehicle
                    <button type="button" class="btn btn-primary waves-effect waves-light float-right " data-toggle="modal" data-target=".bs-example-modal-lg"> <i class="fa fa-plus"></i> Add Vehicle</button>
                </h4>
            </div>
        </div>
                   ...
                   <form action="{{url('vehicle-store')}}" method="POST">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                            ...
                            <select class="form-control" name="njia_id" >
                                <option>--Route--</option>
